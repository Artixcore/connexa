...
@endphp
		...
		<section class="cover-sec">
			...
			<img src="{{ url('user')}}/{{ $user->cover_avatar }}" style="height:350px;" alt="">
				...
				<div class="container">
					<div class="row no-gutters">
						<div class="col-lg-12 col-sm-12">
							...
							<a class="btn btn-success" data-toggle="modal" data-target="#cover_avatar_up" href="#">Change Image</a>
						</div>
					</div>
				</div>
			</div>
								...
								<div class="main-left-sidebar">
									<div class="user_profile">
										<div class="user-pro-img">
											<img src="{{ url('user')}}/{{ Auth::user()->avatar }}" alt="{{ Auth::user()->name }}">
											<div class="add-dp" data-toggle="modal" data-target="#avatar_up" href="#">
										...
										<ul class="social_links">
											<li><a href="#" data-toggle="modal" data-target="#website"><i class="la la-globe"></i></a></li>

                                        @foreach ($websites as $website)
                                       	<li><a href="{{$website->user_website_name}}" title="{{ $website->user_website_link }}"><i class="la la-globe"></i> {{ $website->user_website_link }} </a></li>
                                        @endforeach
								...
								<div class="main-ws-sec">
									<div class="user-tab-sec rewivew">
										...
										<div class="star-descp">
											<span>{{ Auth::user()->profession }}</span><br/>
											<ul>
									...
									<div class="product-feed-tab" id="info-dd">
										<div class="user-profile-ov">
											<h3><a href="#" title="">Overview</a>  <a href="#" title="" data-toggle="modal" data-target="#overview"><i class="fa fa-pencil"></i></a></h3>
							...
							<div class="col-lg-3">
								<div class="right-sidebar">
									<div class="message-btn">
										<a href="{{url('profile/edit')}}/{{Auth::user()->id}}" title=""><i class="fas fa-cog"></i> Setting</a>
									</div>
									<div class="widget widget-portfolio">
										...
										<div class="pf-gallery">
											<ul>
												<li><a href="#" title=""><img src="connexa/images/resources/pf-gallery1.png" alt=""></a></li>
												<li><a href="#" title=""><img src="connexa/images/resources/pf-gallery2.png" alt=""></a></li>
												<li><a href="#" title=""><img src="connexa/images/resources/pf-gallery3.png" alt=""></a></li>
												<li><a href="#" title=""><img src="connexa/images/resources/pf-gallery4.png" alt=""></a></li>
												<li><a href="#" title=""><img src="connexa/images/resources/pf-gallery5.png" alt=""></a></li>
												<li><a href="#" title=""><img src="connexa/images/resources/pf-gallery6.png" alt=""></a></li>
												<li><a href="#" title=""><img src="connexa/images/resources/pf-gallery7.png" alt=""></a></li>
												<li><a href="#" title=""><img src="connexa/images/resources/pf-gallery8.png" alt=""></a></li>
												<li><a href="#" title=""><img src="connexa/images/resources/pf-gallery9.png" alt=""></a></li>
												<li><a href="#" title=""><img src="connexa/images/resources/pf-gallery10.png" alt=""></a></li>
												<li><a href="#" title=""><img src="connexa/images/resources/pf-gallery11.png" alt=""></a></li>
												<li><a href="#" title=""><img src="connexa/images/resources/pf-gallery12.png" alt=""></a></li>
											</ul>
										</div><!--pf-gallery end-->
...
@include('fontend.profile.models')
@endsection
