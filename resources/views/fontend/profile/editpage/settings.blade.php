...
<section class="profile-account-setting">
 ...
 <input id="oldpassword" type="password" class="{{ $errors->has('oldpassword') ? ' is-invalid' : '' }}" placeholder="Old Password" name="oldpassword" required autofocus>
<i class="fa fa-lock"></i>
								...
								<input id="password" placeholder="New Password" type="password" class="{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required>
 <i class="fa fa-lock"></i>
                                    ...
                                    @endif
											...
											<div class="cp-field">
												...
												<div class="cpp-fiel">
													 <input id="password-confirm" placeholder="Retype Password" type="password" name="password_confirmation" required>
													<i class="fa fa-lock"></i>
											...
											<div class="cp-field">
												<h5><a href="{{ route('password.request') }}" title="">Forgot Password?</a></h5>
											</div>
