							...
							<div class="col-lg-12">
								<div class="inp-field">
									<select name="job_category">
										...
										<option value="IT">Part Time</option>
									</select>
								</div>
							</div>
							<div class="col-lg-12">
								<input type="text" name="job_skill" placeholder="Skills">
							</div>
							<div class="col-lg-12">
								<div class="price-sec">
									<div class="price-br">
										<input type="text" name="job_price_start" placeholder="Price">
										<i class="la la-dollar"></i>
									</div>
									<span>To</span>
									<div class="price-br">
										<input type="text" name="job_price_end" placeholder="Price">
										<i class="la la-dollar"></i>
									</div>
								</div>
							</div>
							<div class="col-lg-12">
								<textarea name="job_desc" placeholder="Description"></textarea>
							</div>
							<div class="col-lg-12">
								<ul>
