							...
							<div class="col-lg-3 col-md-4 pd-left-none no-pd">
								<div class="main-left-sidebar no-margin">
									<div class="user-data full-width">
										<div class="user-profile">
											...
											<div class="user-specs">
												<h3>{{Auth::user()->profiles->first_name}} {{Auth::user()->profiles->last_name}}</h3>
										...
										<ul class="user-fw-status">
											...
											<li>
												<a href="{{url('my-profile')}}" title="">View Profile</a>
											</li>
										</ul>
									</div><!--user-data end-->
									...
									<div class="tags-sec full-width">
										...
										<div class="cp-sec">
											<img src="images/connexa.png" alt="">
										</div>
									</div><!--tags-sec end-->
...
<!-- Mirrored from gambolthemes.net/workwise-new/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Oct 2020 13:04:54 GMT -->
</html>