...
Route::get('/puv', function () {
    // return view('lay.nav');
    return view('fontend.public');
});

Route::get('/puvv', function () {
    // return view('lay.nav');
    return view('fontend.public.review');
});
...
// Settings
Route::get('profile/edit/{id}', 'ProfileController@settings');
